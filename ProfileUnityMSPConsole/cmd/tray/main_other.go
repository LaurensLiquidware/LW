...
// This tray launcher wraps profileunity-msp-console-server.exe with a
...
// in main_windows.go.
func main() {
	fmt.Println("profileunity-msp-console tray launcher is Windows-only; run profileunity-msp-console-server directly on this platform.")
}
