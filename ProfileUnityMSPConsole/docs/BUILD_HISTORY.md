...
This is an archived, no-longer-updated record of how this console was
originally built, phase by phase (Phases 1-8 are all complete; nothing
further will be appended here). For what changed release to release
since, see `CHANGELOG.md` instead — this file is background context, not
a live status page.
